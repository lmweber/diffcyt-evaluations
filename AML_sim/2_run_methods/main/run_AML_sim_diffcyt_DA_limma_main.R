...
plotting_diffcyt_DA_limma_main <- vector("list", length(thresholds))
names(plotting_diffcyt_DA_limma_main) <- thresholds
...
for (th in 1:length(thresholds)) {
  ...
  plotting_diffcyt_DA_limma_main[[th]] <- list(d_se = d_se, 
                                               d_counts = d_counts, 
                                               d_medians = d_medians, 
...
save(plotting_diffcyt_DA_limma_main, 
     file = file.path(DIR_RDATA, "plotting_AML_sim_diffcyt_DA_limma_main.RData"))
