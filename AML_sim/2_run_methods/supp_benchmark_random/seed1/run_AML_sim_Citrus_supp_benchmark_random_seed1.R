...
DIR_CITRUS_FILES <- "../../../../../Citrus_files/AML_sim/supp_benchmark_random/seed1"
...
out_Citrus_supp_benchmark_random_seed1 <- runtime_Citrus_supp_benchmark_random_seed1 <- vector("list", length(thresholds))
names(out_Citrus_supp_benchmark_random_seed1) <- names(runtime_Citrus_supp_benchmark_random_seed1) <- thresholds
...
for (th in 1:length(thresholds)) {
  ...
  out_Citrus_supp_benchmark_random_seed1[[th]] <- runtime_Citrus_supp_benchmark_random_seed1[[th]] <- vector("list", length(cond_names))
  names(out_Citrus_supp_benchmark_random_seed1[[th]]) <- names(runtime_Citrus_supp_benchmark_random_seed1[[th]]) <- cond_names
  ...
  for (j in 1:length(cond_names)) {
    ...
    runtime_Citrus_supp_benchmark_random_seed1[[th]][[j]] <- runtime_total
    ...
    # store results
    out_Citrus_supp_benchmark_random_seed1[[th]][[j]] <- res
...
save(out_Citrus_supp_benchmark_random_seed1, runtime_Citrus_supp_benchmark_random_seed1, 
     file = file.path(DIR_RDATA, "outputs_AML_sim_Citrus_supp_benchmark_random_seed1.RData"))
...
sink(file.path(DIR_SESSION_INFO, "session_info_AML_sim_Citrus_supp_benchmark_random_seed1.txt"))
sessionInfo()
sink()
