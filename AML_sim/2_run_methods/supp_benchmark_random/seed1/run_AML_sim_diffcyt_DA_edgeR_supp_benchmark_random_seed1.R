...
DIR_BENCHMARK <- "../../../../../../benchmark_data/AML_sim/data/random_seeds/seed1"
DIR_RDATA <- "../../../../../RData/AML_sim/supp_benchmark_random/seed1"
DIR_SESSION_INFO <- "../../../../session_info/AML_sim/supp_benchmark_random/seed1"
...
out_diffcyt_DA_edgeR_supp_benchmark_random_seed1 <- runtime_diffcyt_DA_edgeR_supp_benchmark_random_seed1 <- vector("list", length(thresholds))
names(out_diffcyt_DA_edgeR_supp_benchmark_random_seed1) <- names(runtime_diffcyt_DA_edgeR_supp_benchmark_random_seed1) <- thresholds
...
for (th in 1:length(thresholds)) {
  ...
  out_diffcyt_DA_edgeR_supp_benchmark_random_seed1[[th]] <- runtime_diffcyt_DA_edgeR_supp_benchmark_random_seed1[[th]] <- vector("list", length(cond_names))
  names(out_diffcyt_DA_edgeR_supp_benchmark_random_seed1[[th]]) <- names(runtime_diffcyt_DA_edgeR_supp_benchmark_random_seed1[[th]]) <- cond_names
  ...
  for (j in 1:length(cond_names)) {
    ...
    runtime_diffcyt_DA_edgeR_supp_benchmark_random_seed1[[th]][[j]] <- runtime_total
    ...
    # store results
    out_diffcyt_DA_edgeR_supp_benchmark_random_seed1[[th]][[j]] <- res
...
save(out_diffcyt_DA_edgeR_supp_benchmark_random_seed1, runtime_diffcyt_DA_edgeR_supp_benchmark_random_seed1, 
     file = file.path(DIR_RDATA, "outputs_AML_sim_diffcyt_DA_edgeR_supp_benchmark_random_seed1.RData"))
...
sink(file.path(DIR_SESSION_INFO, "session_info_AML_sim_diffcyt_DA_edgeR_supp_benchmark_random_seed1.txt"))
sessionInfo()
sink()
