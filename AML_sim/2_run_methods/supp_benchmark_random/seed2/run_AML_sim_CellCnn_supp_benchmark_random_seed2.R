...
DIR_CELLCNN_FILES <- "../../../../../CellCnn_files/AML_sim/supp_benchmark_random/seed2"
...
out_CellCnn_supp_benchmark_random_seed2 <- runtime_CellCnn_supp_benchmark_random_seed2 <- vector("list", length(thresholds))
names(out_CellCnn_supp_benchmark_random_seed2) <- names(runtime_CellCnn_supp_benchmark_random_seed2) <- thresholds
...
for (th in 1:length(thresholds)) {
  ...
  out_CellCnn_supp_benchmark_random_seed2[[th]] <- runtime_CellCnn_supp_benchmark_random_seed2[[th]] <- vector("list", length(cond_names))
  names(out_CellCnn_supp_benchmark_random_seed2[[th]]) <- names(runtime_CellCnn_supp_benchmark_random_seed2[[th]]) <- cond_names
  ...
  for (j in 1:length(cond_names)) {
    ...
    runtime_CellCnn_supp_benchmark_random_seed2[[th]][[j]] <- runtime_total
    ...
    # store results
    out_CellCnn_supp_benchmark_random_seed2[[th]][[j]] <- res
...
save(out_CellCnn_supp_benchmark_random_seed2, runtime_CellCnn_supp_benchmark_random_seed2, 
     file = file.path(DIR_RDATA, "outputs_AML_sim_CellCnn_supp_benchmark_random_seed2.RData"))
...
sink(file.path(DIR_SESSION_INFO, "session_info_AML_sim_CellCnn_supp_benchmark_random_seed2.txt"))
sessionInfo()
sink()
