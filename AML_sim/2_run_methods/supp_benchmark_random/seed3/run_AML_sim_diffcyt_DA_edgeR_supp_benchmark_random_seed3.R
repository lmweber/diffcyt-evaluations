...
DIR_BENCHMARK <- "../../../../../../benchmark_data/AML_sim/data/random_seeds/seed3"
DIR_RDATA <- "../../../../../RData/AML_sim/supp_benchmark_random/seed3"
DIR_SESSION_INFO <- "../../../../../session_info/AML_sim/supp_benchmark_random/seed3"
...
out_diffcyt_DA_edgeR_supp_benchmark_random_seed3 <- runtime_diffcyt_DA_edgeR_supp_benchmark_random_seed3 <- vector("list", length(thresholds))
names(out_diffcyt_DA_edgeR_supp_benchmark_random_seed3) <- names(runtime_diffcyt_DA_edgeR_supp_benchmark_random_seed3) <- thresholds
...
for (th in 1:length(thresholds)) {
  ...
  out_diffcyt_DA_edgeR_supp_benchmark_random_seed3[[th]] <- runtime_diffcyt_DA_edgeR_supp_benchmark_random_seed3[[th]] <- vector("list", length(cond_names))
  names(out_diffcyt_DA_edgeR_supp_benchmark_random_seed3[[th]]) <- names(runtime_diffcyt_DA_edgeR_supp_benchmark_random_seed3[[th]]) <- cond_names
  ...
  for (j in 1:length(cond_names)) {
    ...
    runtime_diffcyt_DA_edgeR_supp_benchmark_random_seed3[[th]][[j]] <- runtime_total
    ...
    # store results
    out_diffcyt_DA_edgeR_supp_benchmark_random_seed3[[th]][[j]] <- res
...
save(out_diffcyt_DA_edgeR_supp_benchmark_random_seed3, runtime_diffcyt_DA_edgeR_supp_benchmark_random_seed3, 
     file = file.path(DIR_RDATA, "outputs_AML_sim_diffcyt_DA_edgeR_supp_benchmark_random_seed3.RData"))
...
sink(file.path(DIR_SESSION_INFO, "session_info_AML_sim_diffcyt_DA_edgeR_supp_benchmark_random_seed3.txt"))
sessionInfo()
sink()
