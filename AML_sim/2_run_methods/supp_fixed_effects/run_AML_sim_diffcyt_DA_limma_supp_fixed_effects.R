...
out_diffcyt_DA_limma_supp_fixed_effects <- vector("list", length(thresholds))
names(out_diffcyt_DA_limma_supp_fixed_effects) <- thresholds
...
for (th in 1:length(thresholds)) {
  ...
  out_diffcyt_DA_limma_supp_fixed_effects[[th]] <- vector("list", length(cond_names))
  names(out_diffcyt_DA_limma_supp_fixed_effects[[th]]) <- cond_names
...
save(out_diffcyt_DA_limma_supp_fixed_effects, file = file.path(DIR_RDATA, "outputs_AML_sim_diffcyt_DA_limma_supp_fixed_effects.RData"))
