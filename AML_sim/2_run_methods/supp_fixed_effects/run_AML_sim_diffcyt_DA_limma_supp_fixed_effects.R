...
out_diffcyt_DA_limma_supp_fixed_effects <- runtime_diffcyt_DA_limma_supp_fixed_effects <- vector("list", length(thresholds))
names(out_diffcyt_DA_limma_supp_fixed_effects) <- names(runtime_diffcyt_DA_limma_supp_fixed_effects) <- thresholds
...
for (th in 1:length(thresholds)) {
  ...
  out_diffcyt_DA_limma_supp_fixed_effects[[th]] <- runtime_diffcyt_DA_limma_supp_fixed_effects[[th]] <- vector("list", length(cond_names))
  names(out_diffcyt_DA_limma_supp_fixed_effects[[th]]) <- names(runtime_diffcyt_DA_limma_supp_fixed_effects[[th]]) <- cond_names
  ...
  for (j in 1:length(cond_names)) {
    ...
    runtime_j <- system.time({
      ...
      # run tests
      res <- testDA_limma(d_counts, design, contrast, plot = FALSE)
    ...
    runtime_diffcyt_DA_limma_supp_fixed_effects[[th]][[j]] <- runtime_total
    ...
    # store results
    out_diffcyt_DA_limma_supp_fixed_effects[[th]][[j]] <- res
...
save(out_diffcyt_DA_limma_supp_fixed_effects, runtime_diffcyt_DA_limma_supp_fixed_effects, 
     file = file.path(DIR_RDATA, "outputs_AML_sim_diffcyt_DA_limma_supp_fixed_effects.RData"))
...
sink(file.path(DIR_SESSION_INFO, "session_info_AML_sim_diffcyt_DA_limma_supp_fixed_effects.txt"))
sessionInfo()
sink()
