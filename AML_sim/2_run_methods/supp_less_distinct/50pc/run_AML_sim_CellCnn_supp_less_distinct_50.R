...
# - data set: AML-sim
# 
# - supplementary results: less distinct population (mean difference reduced by 50%)
# 
...
DIR_BENCHMARK <- "../../../../../../benchmark_data/AML_sim/data/less_distinct/50pc"
DIR_CELLCNN <- "../../../../../../CellCnn/CellCnn"
DIR_CELLCNN_FILES <- "../../../../../CellCnn_files/AML_sim/supp_less_distinct/50pc"
DIR_RDATA <- "../../../../../RData/AML_sim/supp_less_distinct/50pc"
DIR_SESSION_INFO <- "../../../../../session_info/AML_sim/supp_less_distinct/50pc"
...
out_CellCnn_supp_less_distinct_50 <- runtime_CellCnn_supp_less_distinct_50 <- vector("list", length(thresholds))
names(out_CellCnn_supp_less_distinct_50) <- names(runtime_CellCnn_supp_less_distinct_50) <- thresholds
...
for (th in 1:length(thresholds)) {
  ...
  out_CellCnn_supp_less_distinct_50[[th]] <- runtime_CellCnn_supp_less_distinct_50[[th]] <- vector("list", length(cond_names))
  names(out_CellCnn_supp_less_distinct_50[[th]]) <- names(runtime_CellCnn_supp_less_distinct_50[[th]]) <- cond_names
  ...
  for (j in 1:length(cond_names)) {
    ...
    runtime_CellCnn_supp_less_distinct_50[[th]][[j]] <- runtime_total
    ...
    # store results
    out_CellCnn_supp_less_distinct_50[[th]][[j]] <- res
...
save(out_CellCnn_supp_less_distinct_50, runtime_CellCnn_supp_less_distinct_50, 
     file = file.path(DIR_RDATA, "outputs_AML_sim_CellCnn_supp_less_distinct_50.RData"))
...
sink(file.path(DIR_SESSION_INFO, "session_info_AML_sim_CellCnn_supp_less_distinct_50.txt"))
sessionInfo()
sink()
