...
DIR_CITRUS_FILES <- "../../../../../Citrus_files/AML_sim/supp_less_distinct/50pc"
...
out_Citrus_supp_less_distinct_50 <- runtime_Citrus_supp_less_distinct_50 <- vector("list", length(thresholds))
names(out_Citrus_supp_less_distinct_50) <- names(runtime_Citrus_supp_less_distinct_50) <- thresholds
...
for (th in 1:length(thresholds)) {
  ...
  out_Citrus_supp_less_distinct_50[[th]] <- runtime_Citrus_supp_less_distinct_50[[th]] <- vector("list", length(cond_names))
  names(out_Citrus_supp_less_distinct_50[[th]]) <- names(runtime_Citrus_supp_less_distinct_50[[th]]) <- cond_names
  ...
  for (j in 1:length(cond_names)) {
    ...
    runtime_Citrus_supp_less_distinct_50[[th]][[j]] <- runtime_total
    ...
    # store results
    out_Citrus_supp_less_distinct_50[[th]][[j]] <- res
...
save(out_Citrus_supp_less_distinct_50, runtime_Citrus_supp_less_distinct_50, 
     file = file.path(DIR_RDATA, "outputs_AML_sim_Citrus_supp_less_distinct_50.RData"))
...
sink(file.path(DIR_SESSION_INFO, "session_info_AML_sim_Citrus_supp_less_distinct_50.txt"))
sessionInfo()
sink()
