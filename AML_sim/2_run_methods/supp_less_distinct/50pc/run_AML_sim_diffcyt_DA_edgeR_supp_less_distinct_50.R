...
out_diffcyt_DA_edgeR_supp_less_distinct_50 <- runtime_diffcyt_DA_edgeR_supp_less_distinct_50 <- vector("list", length(thresholds))
names(out_diffcyt_DA_edgeR_supp_less_distinct_50) <- names(runtime_diffcyt_DA_edgeR_supp_less_distinct_50) <- thresholds
...
for (th in 1:length(thresholds)) {
  ...
  out_diffcyt_DA_edgeR_supp_less_distinct_50[[th]] <- runtime_diffcyt_DA_edgeR_supp_less_distinct_50[[th]] <- vector("list", length(cond_names))
  names(out_diffcyt_DA_edgeR_supp_less_distinct_50[[th]]) <- names(runtime_diffcyt_DA_edgeR_supp_less_distinct_50[[th]]) <- cond_names
  ...
  for (j in 1:length(cond_names)) {
    ...
    runtime_diffcyt_DA_edgeR_supp_less_distinct_50[[th]][[j]] <- runtime_total
    ...
    # store results
    out_diffcyt_DA_edgeR_supp_less_distinct_50[[th]][[j]] <- res
...
save(out_diffcyt_DA_edgeR_supp_less_distinct_50, runtime_diffcyt_DA_edgeR_supp_less_distinct_50, 
     file = file.path(DIR_RDATA, "outputs_AML_sim_diffcyt_DA_edgeR_supp_less_distinct_50.RData"))
...
sink(file.path(DIR_SESSION_INFO, "session_info_AML_sim_diffcyt_DA_edgeR_supp_less_distinct_50.txt"))
sessionInfo()
sink()
