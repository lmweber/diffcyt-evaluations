...
out_diffcyt_DA_edgeR_supp_less_distinct <- runtime_diffcyt_DA_edgeR_supp_less_distinct <- 
  out_clusters_diffcyt_DA_edgeR_supp_less_distinct <- out_objects_diffcyt_DA_edgeR_supp_less_distinct <- 
  vector("list", length(distinctness))
names(out_diffcyt_DA_edgeR_supp_less_distinct) <- names(runtime_diffcyt_DA_edgeR_supp_less_distinct) <- 
  names(out_clusters_diffcyt_DA_edgeR_supp_less_distinct) <- names(out_objects_diffcyt_DA_edgeR_supp_less_distinct) <- 
  names(distinctness)
...
for (di in 1:length(distinctness)) {
  ...
  out_diffcyt_DA_edgeR_supp_less_distinct[[di]] <- runtime_diffcyt_DA_edgeR_supp_less_distinct[[di]] <- 
    out_clusters_diffcyt_DA_edgeR_supp_less_distinct[[di]] <- out_objects_diffcyt_DA_edgeR_supp_less_distinct[[di]] <- 
    vector("list", length(thresholds))
  names(out_diffcyt_DA_edgeR_supp_less_distinct[[di]]) <- names(runtime_diffcyt_DA_edgeR_supp_less_distinct[[di]]) <- 
    names(out_clusters_diffcyt_DA_edgeR_supp_less_distinct[[di]]) <- names(out_objects_diffcyt_DA_edgeR_supp_less_distinct[[di]]) <- 
    thresholds
  ...
  for (th in 1:length(thresholds)) {
    ...
    out_objects_diffcyt_DA_edgeR_supp_less_distinct[[di]][[th]] <- list(
      d_se = d_se, 
      d_counts = d_counts, 
      d_medians = d_medians, 
    ...
    out_diffcyt_DA_edgeR_supp_less_distinct[[di]][[th]] <- runtime_diffcyt_DA_edgeR_supp_less_distinct[[di]][[th]] <- 
      out_clusters_diffcyt_DA_edgeR_supp_less_distinct[[di]][[th]] <- vector("list", length(cond_names))
    names(out_diffcyt_DA_edgeR_supp_less_distinct[[di]][[th]]) <- names(runtime_diffcyt_DA_edgeR_supp_less_distinct[[di]][[th]]) <- 
      names(out_clusters_diffcyt_DA_edgeR_supp_less_distinct[[di]][[th]]) <- cond_names
    ...
    for (j in 1:length(cond_names)) {
      ...
      runtime_diffcyt_DA_edgeR_supp_less_distinct[[di]][[th]][[j]] <- runtime_total
      ...
      out_clusters_diffcyt_DA_edgeR_supp_less_distinct[[di]][[th]][[j]] <- res_clusters
      ...
      # store results
      out_diffcyt_DA_edgeR_supp_less_distinct[[di]][[th]][[j]] <- res
...
save(out_diffcyt_DA_edgeR_supp_less_distinct, runtime_diffcyt_DA_edgeR_supp_less_distinct, 
     file = file.path(DIR_RDATA, "outputs_AML_sim_diffcyt_DA_edgeR_supp_less_distinct.RData"))

save(out_clusters_diffcyt_DA_edgeR_supp_less_distinct, 
     file = file.path(DIR_RDATA, "out_clusters_AML_sim_diffcyt_DA_edgeR_supp_less_distinct.RData"))

save(out_objects_diffcyt_DA_edgeR_supp_less_distinct, 
     file = file.path(DIR_RDATA, "out_objects_AML_sim_diffcyt_DA_edgeR_supp_less_distinct.RData"))
...
sink(file.path(DIR_SESSION_INFO, "session_info_AML_sim_diffcyt_DA_edgeR_supp_less_distinct.txt"))
sessionInfo()
sink()
