...
out_diffcyt_DA_GLMM_supp_metaclustering <- runtime_diffcyt_DA_GLMM_supp_metaclustering <- 
  out_clusters_diffcyt_DA_GLMM_supp_metaclustering <- out_objects_diffcyt_DA_GLMM_supp_metaclustering <- 
  vector("list", length(thresholds))
names(out_diffcyt_DA_GLMM_supp_metaclustering) <- names(runtime_diffcyt_DA_GLMM_supp_metaclustering) <- 
  names(out_clusters_diffcyt_DA_GLMM_supp_metaclustering) <- names(out_objects_diffcyt_DA_GLMM_supp_metaclustering) <- 
  thresholds
...
for (th in 1:length(thresholds)) {
  ...
  out_objects_diffcyt_DA_GLMM_supp_metaclustering[[th]] <- list(
    d_se = d_se, 
    d_counts = d_counts, 
    d_medians = d_medians, 
  ...
  out_diffcyt_DA_GLMM_supp_metaclustering[[th]] <- runtime_diffcyt_DA_GLMM_supp_metaclustering[[th]] <- 
    out_clusters_diffcyt_DA_GLMM_supp_metaclustering[[th]] <- vector("list", length(cond_names))
  names(out_diffcyt_DA_GLMM_supp_metaclustering[[th]]) <- names(runtime_diffcyt_DA_GLMM_supp_metaclustering[[th]]) <- 
    names(out_clusters_diffcyt_DA_GLMM_supp_metaclustering[[th]]) <- cond_names
  ...
  for (j in 1:length(cond_names)) {
    ...
    runtime_diffcyt_DA_GLMM_supp_metaclustering[[th]][[j]] <- runtime_total
    ...
    out_clusters_diffcyt_DA_GLMM_supp_metaclustering[[th]][[j]] <- res_clusters
    ...
    # store results
    out_diffcyt_DA_GLMM_supp_metaclustering[[th]][[j]] <- res
...
save(out_diffcyt_DA_GLMM_supp_metaclustering, runtime_diffcyt_DA_GLMM_supp_metaclustering, 
     file = file.path(DIR_RDATA, "outputs_AML_sim_diffcyt_DA_GLMM_supp_metaclustering.RData"))

save(out_clusters_diffcyt_DA_GLMM_supp_metaclustering, 
     file = file.path(DIR_RDATA, "out_clusters_AML_sim_diffcyt_DA_GLMM_supp_metaclustering.RData"))

save(out_objects_diffcyt_DA_GLMM_supp_metaclustering, 
     file = file.path(DIR_RDATA, "out_objects_AML_sim_diffcyt_DA_GLMM_supp_metaclustering.RData"))
...
sink(file.path(DIR_SESSION_INFO, "session_info_AML_sim_diffcyt_DA_GLMM_supp_metaclustering.txt"))
sessionInfo()
sink()
