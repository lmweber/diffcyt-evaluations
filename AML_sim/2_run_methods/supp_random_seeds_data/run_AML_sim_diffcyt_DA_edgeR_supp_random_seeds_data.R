...
out_diffcyt_DA_edgeR_supp_random_seeds_data <- runtime_diffcyt_DA_edgeR_supp_random_seeds_data <- 
  out_clusters_diffcyt_DA_edgeR_supp_random_seeds_data <- out_objects_diffcyt_DA_edgeR_supp_random_seeds_data <- 
  vector("list", length(seed_names))
names(out_diffcyt_DA_edgeR_supp_random_seeds_data) <- names(runtime_diffcyt_DA_edgeR_supp_random_seeds_data) <- 
  names(out_clusters_diffcyt_DA_edgeR_supp_random_seeds_data) <- names(out_objects_diffcyt_DA_edgeR_supp_random_seeds_data) <- 
  seed_names
...
for (s in 1:length(seed_names)) {
  ...
  out_diffcyt_DA_edgeR_supp_random_seeds_data[[s]] <- runtime_diffcyt_DA_edgeR_supp_random_seeds_data[[s]] <- 
    out_clusters_diffcyt_DA_edgeR_supp_random_seeds_data[[s]] <- out_objects_diffcyt_DA_edgeR_supp_random_seeds_data[[s]] <- 
    vector("list", length(thresholds))
  names(out_diffcyt_DA_edgeR_supp_random_seeds_data[[s]]) <- names(runtime_diffcyt_DA_edgeR_supp_random_seeds_data[[s]]) <- 
    names(out_clusters_diffcyt_DA_edgeR_supp_random_seeds_data[[s]]) <- names(out_objects_diffcyt_DA_edgeR_supp_random_seeds_data[[s]]) <- 
    thresholds
  ...
  for (th in 1:length(thresholds)) {
    ...
    out_objects_diffcyt_DA_edgeR_supp_random_seeds_data[[s]][[th]] <- list(
      d_se = d_se, 
      d_counts = d_counts, 
      d_medians = d_medians, 
    ...
    out_diffcyt_DA_edgeR_supp_random_seeds_data[[s]][[th]] <- runtime_diffcyt_DA_edgeR_supp_random_seeds_data[[s]][[th]] <- 
      out_clusters_diffcyt_DA_edgeR_supp_random_seeds_data[[s]][[th]] <- vector("list", length(cond_names))
    names(out_diffcyt_DA_edgeR_supp_random_seeds_data[[s]][[th]]) <- names(runtime_diffcyt_DA_edgeR_supp_random_seeds_data[[s]][[th]]) <- 
      names(out_clusters_diffcyt_DA_edgeR_supp_random_seeds_data[[s]][[th]]) <- cond_names
    ...
    for (j in 1:length(cond_names)) {
      ...
      runtime_diffcyt_DA_edgeR_supp_random_seeds_data[[s]][[th]][[j]] <- runtime_total
      ...
      out_clusters_diffcyt_DA_edgeR_supp_random_seeds_data[[s]][[th]][[j]] <- res_clusters
      ...
      # store results
      out_diffcyt_DA_edgeR_supp_random_seeds_data[[s]][[th]][[j]] <- res
...
save(out_diffcyt_DA_edgeR_supp_random_seeds_data, runtime_diffcyt_DA_edgeR_supp_random_seeds_data, 
     file = file.path(DIR_RDATA, "outputs_AML_sim_diffcyt_DA_edgeR_supp_random_seeds_data.RData"))

save(out_clusters_diffcyt_DA_edgeR_supp_random_seeds_data, 
     file = file.path(DIR_RDATA, "out_clusters_AML_sim_diffcyt_DA_edgeR_supp_random_seeds_data.RData"))

save(out_objects_diffcyt_DA_edgeR_supp_random_seeds_data, 
     file = file.path(DIR_RDATA, "out_objects_AML_sim_diffcyt_DA_edgeR_supp_random_seeds_data.RData"))
...
sink(file.path(DIR_SESSION_INFO, "session_info_AML_sim_diffcyt_DA_edgeR_supp_random_seeds_data.txt"))
sessionInfo()
sink()
