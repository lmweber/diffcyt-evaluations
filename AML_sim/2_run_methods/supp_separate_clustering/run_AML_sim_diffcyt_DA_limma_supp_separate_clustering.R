...
out_diffcyt_DA_limma_supp_separate_clustering <- vector("list", length(thresholds))
names(out_diffcyt_DA_limma_supp_separate_clustering) <- thresholds
...
for (th in 1:length(thresholds)) {
  ...
  out_diffcyt_DA_limma_supp_separate_clustering[[th]] <- vector("list", length(cond_names))
  names(out_diffcyt_DA_limma_supp_separate_clustering[[th]]) <- cond_names
...
save(out_diffcyt_DA_limma_supp_separate_clustering, 
