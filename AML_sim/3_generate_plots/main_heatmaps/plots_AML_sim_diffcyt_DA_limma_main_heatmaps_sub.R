...
for (th in 1:length(thresholds)) {
  ...
  for (j in 1:length(cond_names)) {
    ...
    fn <- file.path(DIR_PLOTS, paste0("panels/results_diffcyt_DA_limma_main_heatmap_sub_AML_sim_", thresholds[th], "_", cond_names[j], ".pdf"))
...
fn <- file.path(DIR_PLOTS, paste0("results_diffcyt_DA_limma_main_heatmaps_sub.pdf"))
