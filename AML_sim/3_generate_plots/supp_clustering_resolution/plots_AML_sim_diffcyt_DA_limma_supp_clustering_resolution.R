...
for (th in 1:length(thresholds)) {
  ...
  for (j in 1:length(cond_names)) {
    ...
    data <- list(k_9   = out_diffcyt_DA_limma_supp_clustering_resolution[["k_9"]], 
                 k_25  = out_diffcyt_DA_limma_supp_clustering_resolution[["k_25"]], 
                 k_49  = out_diffcyt_DA_limma_supp_clustering_resolution[["k_49"]], 
                 k_100 = out_diffcyt_DA_limma_supp_clustering_resolution[["k_100"]], 
                 k_196 = out_diffcyt_DA_limma_supp_clustering_resolution[["k_196"]], 
                 k_400 = out_diffcyt_DA_limma_supp_clustering_resolution[["k_400"]], 
                 k_900 = out_diffcyt_DA_limma_supp_clustering_resolution[["k_900"]], 
                 k_1600 = out_diffcyt_DA_limma_supp_clustering_resolution[["k_1600"]])
