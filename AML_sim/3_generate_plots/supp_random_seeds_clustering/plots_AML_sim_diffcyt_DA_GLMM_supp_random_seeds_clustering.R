...
load(file.path(DIR_RDATA_SUPP_RANDOM_SEEDS_CLUSTERING, "outputs_AML_sim_diffcyt_DA_GLMM_supp_random_seeds_clustering.RData"))
...
for (th in 1:length(thresholds)) {
  ...
  for (j in 1:length(cond_names)) {
    ...
    data <- list(main = out_diffcyt_DA_GLMM_main[[th]][[j]], 
                 seed_1 = out_diffcyt_DA_GLMM_supp_random_seeds_clustering[[1]][[th]][[j]], 
                 seed_2 = out_diffcyt_DA_GLMM_supp_random_seeds_clustering[[2]][[th]][[j]], 
                 seed_3 = out_diffcyt_DA_GLMM_supp_random_seeds_clustering[[3]][[th]][[j]])
    ...
    fn <- file.path(DIR_PLOTS, "panels", 
                    paste0("results_AML_sim_diffcyt_DA_GLMM_supp_random_seeds_clustering_ROC_", thresholds[th], "_", cond_names[j], ".pdf"))
...
# save plots
fn_multi <- file.path(DIR_PLOTS, paste0("results_AML_sim_diffcyt_DA_GLMM_supp_random_seeds_clustering_ROC.pdf"))
