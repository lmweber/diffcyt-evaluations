...
for (th in 1:length(thresholds)) {
  ...
  for (j in 1:length(cond_names)) {
    ...
    fn <- file.path(DIR_PLOTS, "panels", 
                    paste0("results_diffcyt_DA_limma_supp_random_starts_ROC_curves_", thresholds[th], "_", cond_names[j], ".pdf"))
...
# save plots
fn_ROC <- file.path(DIR_PLOTS, "results_diffcyt_DA_limma_supp_random_starts_ROC_curves.pdf")
