...
load(file.path(DIR_RDATA, "outputs_AML_sim_diffcyt_DA_edgeR_supp_separate_clustering.RData"))
load(file.path(DIR_RDATA, "outputs_AML_sim_diffcyt_DA_limma_supp_separate_clustering.RData"))
load(file.path(DIR_RDATA, "outputs_AML_sim_diffcyt_DA_GLMM_supp_separate_clustering.RData"))
...
for (th in 1:length(thresholds)) {
  ...
  for (j in 1:length(cond_names)) {
    ...
    data <- list(diffcyt_DA_edgeR = out_diffcyt_DA_edgeR_supp_separate_clustering[[th]][[j]], 
                 diffcyt_DA_limma = out_diffcyt_DA_limma_supp_separate_clustering[[th]][[j]], 
                 diffcyt_DA_GLMM = out_diffcyt_DA_GLMM_supp_separate_clustering[[th]][[j]])
    ...
    p_ROC <- 
      ...
      ggtitle(paste0("AML-sim: separate clustering, ", cond_names[j], ", ", gsub("pc$", "\\%", thresholds[th])), subtitle = "ROC curve") + 
      theme_bw() + 
      theme(strip.text.x = element_blank()) + 
      guides(color = guide_legend("method"))
    
    # save individual panel plot
    fn <- file.path(DIR_PLOTS, "panels", paste0("results_AML_sim_diffcyt_supp_separate_clustering_ROC_", thresholds[th], "_", cond_names[j], ".pdf"))
    ...
    p_TPRFDR <- 
      ...
      ggtitle(paste0("AML-sim: separate clustering, ", cond_names[j], ", ", gsub("pc$", "\\%", thresholds[th])), subtitle = "TPR vs. FDR") + 
      theme_bw() + 
      theme(strip.text.x = element_blank()) + 
    ...
    # save individual panel plot
    fn <- file.path(DIR_PLOTS, "panels", paste0("results_AML_sim_diffcyt_supp_separate_clustering_TPRFDR_", thresholds[th], "_", cond_names[j], ".pdf"))
    ggsave(fn, width = 4.75, height = 3.5)
    ...
    p_TPR <- 
      ...
      ggtitle(paste0("AML-sim: separate clustering, ", cond_names[j], ", ", gsub("pc$", "\\%", thresholds[th])), subtitle = "TPR") + 
      theme_bw() + 
      theme(strip.text.x = element_blank(), 
    ...
    # save individual panel plot
    fn <- file.path(DIR_PLOTS, "panels", paste0("results_AML_sim_diffcyt_supp_separate_clustering_TPR_", thresholds[th], "_", cond_names[j], ".pdf"))
    ggsave(fn, width = 4.75, height = 3.5)
    ...
    p_FPR <- 
      ...
      #coord_fixed() + 
      xlab("False positive rate") + 
      ggtitle(paste0("AML-sim: separate clustering, ", cond_names[j], ", ", gsub("pc$", "\\%", thresholds[th])), subtitle = "FPR") + 
      theme_bw() + 
      theme(strip.text.x = element_blank(), 
            axis.text.y = element_blank()) + 
      guides(shape = guide_legend("FDR threshold", override.aes = list(size = 4), order = 1), 
    ...
    # save individual panel plot
    fn <- file.path(DIR_PLOTS, "panels", paste0("results_AML_sim_diffcyt_supp_separate_clustering_FPR_", thresholds[th], "_", cond_names[j], ".pdf"))
    ggsave(fn, width = 4.75, height = 3.5)
    ...
    fn <- file.path(DIR_PLOTS, paste0("results_AML_sim_diffcyt_supp_separate_clustering_", thresholds[th], "_", cond_names[j], ".pdf"))
...
for (j in 1:length(cond_names)) {
  ...
  # save combined plot
  fn <- file.path(DIR_PLOTS, paste0("results_AML_sim_diffcyt_supp_separate_clustering_", cond_names[j], ".pdf"))
