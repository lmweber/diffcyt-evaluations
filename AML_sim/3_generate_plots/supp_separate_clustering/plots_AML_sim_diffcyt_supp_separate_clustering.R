...
load(file.path(DIR_RDATA, "outputs_AML_sim_diffcyt_DA_voom_supp_separate_clustering.RData"))
...
for (th in 1:length(thresholds)) {
  ...
  for (j in 1:length(cond_names)) {
    ...
    data <- list(diffcyt_DA_edgeR = out_diffcyt_DA_edgeR_supp_separate_clustering[[th]][[j]], 
                 diffcyt_DA_voom = out_diffcyt_DA_voom_supp_separate_clustering[[th]][[j]], 
