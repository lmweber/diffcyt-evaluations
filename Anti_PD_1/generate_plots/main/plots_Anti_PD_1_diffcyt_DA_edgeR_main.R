...
d_medians_all <- out_objects_diffcyt_DA_edgeR_main$d_medians_all
...
# save plot
fn <- file.path(DIR_PLOTS, "results_Anti_PD_1_diffcyt_DA_edgeR_main_heatmap_phenotype.pdf")
...
# save plot
fn <- file.path(DIR_PLOTS, "results_Anti_PD_1_diffcyt_DA_edgeR_main_heatmap_abundance.pdf")
pdf(fn, width = 8, height = 1.85)
