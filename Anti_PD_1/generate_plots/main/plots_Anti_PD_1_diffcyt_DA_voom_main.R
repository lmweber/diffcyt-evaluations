...
ht_title <- "Anti-PD-1, diffcyt-DA-voom: detected clusters"

fn <- file.path(DIR_PLOTS, "diffcyt_DA_voom", "results_Anti_PD_1_diffcyt_DA_voom_main_heatmap.pdf")
pdf(fn, width = 12, height = 2.25)
