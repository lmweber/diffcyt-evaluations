...
d_clus <- out_clusters_diffcyt_DS_LMM_main
...
ht_title <- "BCR-XL, diffcyt-DS-LMM: top detected cluster-marker combinations"

fn <- file.path(DIR_PLOTS, "diffcyt_DS_LMM", "results_BCR_XL_diffcyt_DS_LMM_main_phenotypes.pdf")
