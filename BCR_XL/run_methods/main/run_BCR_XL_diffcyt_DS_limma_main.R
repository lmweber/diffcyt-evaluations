...
DIR_PLOTS <- "../../../../plots/BCR_XL/main_diagnostic/diffcyt_DS_limma"
...
# store object
out_objects_diffcyt_DS_limma_main$d_se <- d_se
...
save(runtime_diffcyt_DS_limma_main, 
     file = file.path(DIR_RDATA, "outputs_BCR_XL_diffcyt_DS_limma_main.RData"))

save(out_clusters_diffcyt_DS_limma_main, 
     file = file.path(DIR_RDATA, "out_clusters_BCR_XL_diffcyt_DS_limma_main.RData"))

save(out_objects_diffcyt_DS_limma_main, 
     file = file.path(DIR_RDATA, "out_objects_BCR_XL_diffcyt_DS_limma_main.RData"))
...
sink(file.path(DIR_SESSION_INFO, "session_info_BCR_XL_diffcyt_DS_limma_main.txt"))
sessionInfo()
sink()
