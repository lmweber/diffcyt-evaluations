...
DIR_PLOTS <- "../../../../plots/BCR_XL_sim/main_diagnostic/diffcyt_DS_limma"
...
out_objects_diffcyt_DS_limma_main <- list(
  d_se = d_se, 
  d_counts = d_counts, 
  d_medians = d_medians, 
...
runtime_diffcyt_DS_limma_main <- runtime_total
...
save(out_diffcyt_DS_limma_main, runtime_diffcyt_DS_limma_main, 
     file = file.path(DIR_RDATA, "outputs_BCR_XL_sim_diffcyt_DS_limma_main.RData"))

save(out_clusters_diffcyt_DS_limma_main, 
     file = file.path(DIR_RDATA, "out_clusters_BCR_XL_sim_diffcyt_DS_limma_main.RData"))

save(out_objects_diffcyt_DS_limma_main, 
     file = file.path(DIR_RDATA, "out_objects_BCR_XL_sim_diffcyt_DS_limma_main.RData"))
...
sink(file.path(DIR_SESSION_INFO, "session_info_BCR_XL_sim_diffcyt_DS_limma_main.txt"))
sessionInfo()
sink()
