...
out_objects_diffcyt_DA_GLMM_supp_cell_type_markers <- list(
  d_se = d_se, 
  d_counts = d_counts, 
  d_medians = d_medians, 
...
runtime_diffcyt_DA_GLMM_supp_cell_type_markers <- runtime_total
...
out_clusters_diffcyt_DA_GLMM_supp_cell_type_markers <- res_clusters
...
# store results
out_diffcyt_DA_GLMM_supp_cell_type_markers <- res
...
save(out_diffcyt_DA_GLMM_supp_cell_type_markers, runtime_diffcyt_DA_GLMM_supp_cell_type_markers, 
     file = file.path(DIR_RDATA, "outputs_BCR_XL_sim_diffcyt_DA_GLMM_supp_cell_type_markers.RData"))

save(out_clusters_diffcyt_DA_GLMM_supp_cell_type_markers, 
     file = file.path(DIR_RDATA, "out_clusters_BCR_XL_sim_diffcyt_DA_GLMM_supp_cell_type_markers.RData"))

save(out_objects_diffcyt_DA_GLMM_supp_cell_type_markers, 
     file = file.path(DIR_RDATA, "out_objects_BCR_XL_sim_diffcyt_DA_GLMM_supp_cell_type_markers.RData"))
...
sink(file.path(DIR_SESSION_INFO, "session_info_BCR_XL_sim_diffcyt_DA_GLMM_supp_cell_type_markers.txt"))
sessionInfo()
sink()
