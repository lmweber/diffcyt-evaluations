...
# path to save plots
DIR_PLOTS <- "../../../../plots/BCR_XL_sim/comparisons_all"
...
# color scheme
colors <- c("firebrick1", "darkviolet", "gold2", "darkorange1", "brown4")
...
# save plot
fn <- file.path(DIR_PLOTS, "panels", "results_BCR_XL_sim_comparisons_all_main_ROC.pdf")
...
# save plot
fn <- file.path(DIR_PLOTS, "panels", "results_BCR_XL_sim_comparisons_all_main_TPRFDR.pdf")
ggsave(fn, width = 4.75, height = 3.5)
...
# save plot
fn <- file.path(DIR_PLOTS, "panels", "results_BCR_XL_sim_comparisons_all_main_TPR.pdf")
...
# save plot
fn <- file.path(DIR_PLOTS, "panels", "results_BCR_XL_sim_comparisons_all_main_FPR.pdf")
ggsave(fn, width = 4.5, height = 3.5)
