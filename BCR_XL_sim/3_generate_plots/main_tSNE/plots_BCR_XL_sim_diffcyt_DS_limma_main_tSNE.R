...
# save plot
fn <- file.path(DIR_PLOTS, "panels", "results_BCR_XL_sim_diffcyt_DS_limma_main_tSNE_0.99.pdf")
...
# save plot
fn <- file.path(DIR_PLOTS, "panels", "results_BCR_XL_sim_diffcyt_DS_limma_main_tSNE_0.9.pdf")
ggsave(fn, width = 6, height = 5)
...
# save plot
fn <- file.path(DIR_PLOTS, "panels", "results_BCR_XL_sim_diffcyt_DS_limma_main_tSNE_0.5.pdf")
ggsave(fn, width = 6, height = 5)
...
# save plot
fn <- file.path(DIR_PLOTS, "panels", "results_BCR_XL_sim_diffcyt_DS_limma_main_tSNE_0.1.pdf")
ggsave(fn, width = 6, height = 5)
...
fn <- file.path(DIR_PLOTS, "results_BCR_XL_sim_diffcyt_DS_limma_main_tSNE_all.pdf")
