...
load(file.path(DIR_RDATA, "out_clusters_BCR_XL_sim_diffcyt_DA_GLMM_supp_cell_type_markers.RData"))
load(file.path(DIR_RDATA, "out_objects_BCR_XL_sim_diffcyt_DA_GLMM_supp_cell_type_markers.RData"))
...
d_se <- out_objects_diffcyt_DA_GLMM_supp_cell_type_markers$d_se
d_counts <- out_objects_diffcyt_DA_GLMM_supp_cell_type_markers$d_counts
d_medians <- out_objects_diffcyt_DA_GLMM_supp_cell_type_markers$d_medians
d_medians_by_cluster_marker <- out_objects_diffcyt_DA_GLMM_supp_cell_type_markers$d_medians_by_cluster_marker
...
d_clus <- out_clusters_diffcyt_DA_GLMM_supp_cell_type_markers
...
B_cells <- out_diffcyt_DA_GLMM_supp_cell_type_markers$B_cell
...
ht_title <- "BCR-XL-sim: diffcyt-DA-GLMM"


# (iv) save individual plot

fn <- file.path(DIR_PLOTS, "results_BCR_XL_sim_diffcyt_DA_GLMM_supp_cell_type_markers_heatmap.pdf")
