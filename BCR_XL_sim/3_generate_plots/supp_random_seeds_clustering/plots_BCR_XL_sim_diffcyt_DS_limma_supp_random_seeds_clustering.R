...
load(file.path(DIR_RDATA_SUPP_RANDOM_SEEDS_CLUSTERING, "outputs_BCR_XL_sim_diffcyt_DS_limma_supp_random_seeds_clustering.RData"))
...
data <- list(main = out_diffcyt_DS_limma_main, 
             seed_1 = out_diffcyt_DS_limma_supp_random_seeds_clustering[[1]], 
             seed_2 = out_diffcyt_DS_limma_supp_random_seeds_clustering[[2]], 
             seed_3 = out_diffcyt_DS_limma_supp_random_seeds_clustering[[3]])
...
# color scheme
colors <- rep("firebrick1", length(data))
...
d_plot$method_names <- as.factor("diffcyt-DS-limma")
...
# save plot
fn <- file.path(DIR_PLOTS, "results_BCR_XL_sim_diffcyt_DS_limma_supp_random_seeds_clustering_ROC.pdf")
