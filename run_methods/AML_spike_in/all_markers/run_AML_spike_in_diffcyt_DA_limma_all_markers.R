...
DIR_PLOTS <- "../../../../plots/AML_spike_in/diffcyt_DA_limma/all_markers"
...
save(out_diffcyt_DA_limma_all_markers, file = file.path(DIR_RDATA, "/outputs_AML_spike_in_diffcyt_DA_limma_all_markers.RData"))
...
sink(file.path(DIR_SESSION_INFO, "/session_info_AML_spike_in_diffcyt_DA_limma_all_markers.txt"))
sessionInfo()
sink()
