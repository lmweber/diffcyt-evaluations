...
for (th in 1:length(thresholds)) {
  ...
  # Subset markers of interest and convert input data to required format ('ncdfFlowSet'
  # object)
  # note: using lineage surface markers only
  ...
  # note: not required for this data set, since it is a simulation
...
save.image("../../../RData/outputs_cydar_AML_spike_in.RData")
...
sink("../../../session_info/session_info_cydar_AML_spike_in.txt")
sessionInfo()
sink()
