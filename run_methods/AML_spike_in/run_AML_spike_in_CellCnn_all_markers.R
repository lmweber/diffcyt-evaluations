...
for (th in 1:length(thresholds)) {
  ...
  for (j in 1:length(cond_names)) {
    ...
    path_out <- paste0("../../../CellCnn_files/out_CellCnn/AML_spike_in/all_markers/", thresholds[th], "/", cond_names[j], "/selected_cells")
...
save(out_CellCnn_all_markers, file = "../../../RData/AML_spike_in/outputs_AML_spike_in_CellCnn_all_markers.RData")
